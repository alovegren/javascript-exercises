...
function median(nums) {
  nums.sort((a, b) => a - b);
  // by default, sort's order is according to string unicode code points. it needs to be passed a callback function determining how any two elements should be compared. If the callback function returns a negative number, the first element is considered less than the second. If it returns a positive number, the reverse. If it returns 0, the two elements are considered equal.
