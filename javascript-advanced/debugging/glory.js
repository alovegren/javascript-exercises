...
function roll({max, min}) { // can we use destructuring with an object?
...
} // we haven't included break statements after each case, so the switch statement is 'falling through'
